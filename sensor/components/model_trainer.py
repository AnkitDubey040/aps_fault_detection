...
class ModelTrainer:
    ...
    # For HyperPArameterTuning the model
    def fine_tune(self):
        try:
            #Wite code for Grid Search CV , Random CV 
            pass
        except Exception as e:
            raise SensorException(e, sys)
    ...
    def initiate_model_trainer(self,)->artifact_entity.ModelTrainerArtifact:
        try:
            ...
            # if f1 score for train and test are not near i.e. difference is not near to zero then the model is overfitted
