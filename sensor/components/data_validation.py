...
class DataValidation:
    ...
    #This function reads dataframe and check if sufficient values or not i.e. if Large null values
    ...
    def drop_missing_values_columns(self,df:pd.DataFrame,report_key_name:str)->Optional[pd.DataFrame]:
        ...
        try:
            ...
            # dropping columns with more % of null values than the threshold
    ...
    # to check if the required number of column exists or not after dropping themissing ones
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            ...
            test_df_column_status = self.is_required_column_exists(base_df=base_df, current_df=test_df,report_key_name="missing_columns_within_test_dataset")
